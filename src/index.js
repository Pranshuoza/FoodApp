...
const {storage} = require("../src/config/cloudinaryConfig");
...
app.post("/photo", upload.single("incoming file"), async (req, res) => {
  console.log(req.file);
  const result = await coloudinary.uploader.upload(req.file.path);
